...
execute if score #valid_item itemio.math matches 1 run function itemio:v0.2.0/container/input/custom/repart
data remove storage itemio:main.input ioconfig[0]
execute if data storage itemio:main.input ioconfig[0] run function itemio:v0.2.0/container/input/custom/try_input
