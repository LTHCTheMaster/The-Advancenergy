...
execute if score #input_size itemio.math.input matches 0..26 run function itemio:v0.2.0/container/input/vanilla/27/inf_insert
execute if score #input_size itemio.math.input matches 27 run function itemio:v0.2.0/container/input/vanilla/27/sup_insert

execute if score #full_input itemio.math.input matches 0 if score #max_iteration itemio.math.input matches 1.. run function itemio:v0.2.0/container/input/vanilla/27/try_input
