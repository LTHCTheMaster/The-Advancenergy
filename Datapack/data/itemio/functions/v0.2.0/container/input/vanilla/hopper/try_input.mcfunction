...
execute if score #input_size itemio.math.input matches 0..4 run function itemio:v0.2.0/container/input/vanilla/hopper/inf_insert
execute if score #input_size itemio.math.input matches 5 run function itemio:v0.2.0/container/input/vanilla/hopper/sup_insert

execute if score #full_input itemio.math.input matches 0 if score #max_iteration itemio.math.input matches 1.. run function itemio:v0.2.0/container/input/vanilla/hopper/try_input
