...
execute if score #if_item itemio.math.input matches 0 run function itemio:v0.2.0/container/input/vanilla/3/try_input/side/unless_item
execute if score #if_item itemio.math.input matches 1 run function itemio:v0.2.0/container/input/custom/try_input/1/if_item
