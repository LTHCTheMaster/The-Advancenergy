...
execute if data storage itemio:io filter.ctc.from run function itemio:v0.2.0/container/integrated_filters/ctc/check_from
execute if data storage itemio:io filter.ctc.id run function itemio:v0.2.0/container/integrated_filters/ctc/check_id
