...
execute if score #remove_count itemio.math.output matches 1.. run function itemio:v0.0.3/container/output/vanilla/normal/output_slot
...
execute if score #try_input_after itemio.math.output matches 1 if score #success_input itemio.math.input matches 0 if data storage itemio:main.output Items[0] run function itemio:v0.0.3/container/output/vanilla/normal/repart
