...
execute if score #success_transfer itemio.math matches 0 if data storage itemio:main servo_filters[0] run function itemio:v0.0.3/servo/make_transfer_filters
