...
execute if score #loaded itemio.math matches 1 run execute as @a[tag=convention.debug] run function itemio:v0.0.3/print_version
...
execute if score #loaded itemio.math matches 0 run schedule function itemio:v0.0.3/load_2 2
