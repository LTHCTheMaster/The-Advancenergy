...
execute if score #valid_item itemio.math matches 0 if data storage itemio:main servo_filters2[0] run function itemio:v0.3.0/container/output/try_input_after/filter
