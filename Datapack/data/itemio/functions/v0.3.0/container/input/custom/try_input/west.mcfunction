...
execute if score #valid_item itemio.math matches 1 if data storage itemio:main.input ioconfig[0].allowed_side{west: 1b} run function itemio:v0.3.0/container/input/custom/repart
data remove storage itemio:main.input ioconfig[0]
execute if data storage itemio:main.input ioconfig[0] run function itemio:v0.3.0/container/input/custom/try_input/west
