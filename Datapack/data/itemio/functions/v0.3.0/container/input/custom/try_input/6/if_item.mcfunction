...
execute if score #new_count_container itemio.math.input <= #full_stack itemio.math.input run function itemio:v0.3.0/container/input/custom/try_input/6/if_item/inf/test_nbt
execute if score #new_count_container itemio.math.input > #full_stack itemio.math.input if score #count_container itemio.math.input < #full_stack itemio.math.input run function itemio:v0.3.0/container/input/custom/try_input/6/if_item/sup/test_nbt
