...
execute as @e[type=#itemio:container, tag=itemio.container.initialised] at @s run function itemio:v0.3.0/container/tick
execute as @e[type=hopper_minecart, tag=itemio.minecart_disabled] at @s run function itemio:v0.3.0/container/disable_minecart



execute as @e[type=#itemio:item_frames, tag=itemio.servo.extract, predicate=itemio:internal/good_queue] run function itemio:v0.3.0/servo/test_already
...
schedule function itemio:v0.3.0/tick 1 replace
