...
execute as @e[type=#itemio:container, tag=itemio.container.initialised] at @s run function itemio:v0.5.4/container/tick
execute as @e[type=hopper_minecart, tag=itemio.minecart_disabled] at @s run function itemio:v0.5.4/container/disable_minecart



execute as @e[type=#itemio:item_frames, tag=itemio.servo.extract, tag=itemio.servo.initialised, predicate=itemio:v0.5.4/internal/good_queue] run function itemio:v0.5.4/servo/test_already
