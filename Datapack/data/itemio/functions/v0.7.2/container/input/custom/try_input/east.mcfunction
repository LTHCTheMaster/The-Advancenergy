...
execute if score #filters.valid_item itemio.io matches 1 if data storage itemio:main.input ioconfig[0].allowed_side{east: 1b} run function itemio:v0.7.2/container/input/custom/repart
execute if score #full_input itemio.math.input matches 0 run data remove storage itemio:main.input ioconfig[0]
execute if score #full_input itemio.math.input matches 0 if data storage itemio:main.input ioconfig[0] run function itemio:v0.7.2/container/input/custom/try_input/east
