...
execute if score #filters.valid_item itemio.io matches 1 if data storage itemio:main.input ioconfig[0].allowed_side{top: 1b} run function itemio:v0.7.2/container/input/custom/repart
data remove storage itemio:main.input ioconfig[0]
execute if data storage itemio:main.input ioconfig[0] run function itemio:v0.7.2/container/input/custom/try_input/top
