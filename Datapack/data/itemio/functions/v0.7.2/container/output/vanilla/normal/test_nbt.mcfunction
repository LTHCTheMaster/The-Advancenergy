...
execute if score #!same_item itemio.math.output matches 0 if score #success_output itemio.io matches 0 run function itemio:v0.7.2/container/output/vanilla/normal/output
execute if score #!same_item itemio.math.output matches 1 run data remove storage itemio:main.output Items[0]
execute if score #!same_item itemio.math.output matches 1 if data storage itemio:main.output Items[0] run function itemio:v0.7.2/container/output/vanilla/normal/test_nbt
