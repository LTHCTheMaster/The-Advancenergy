...
execute if score #filters.valid_item itemio.io matches 1 if score #success_output itemio.io matches 0 run function itemio:v0.7.1/container/output/vanilla/normal/output
execute if score #filters.valid_item itemio.io matches 0 run data remove storage itemio:main.output Items[0]
execute if score #filters.valid_item itemio.io matches 0 if data storage itemio:main.output Items[0] run function itemio:v0.7.1/container/output/vanilla/normal/test_filters
