...
execute if score #if_item itemio.math.input matches 0 run function itemio:v0.1.1/container/input/vanilla/3/try_input/top/unless_item
execute if score #if_item itemio.math.input matches 1 run function itemio:v0.1.1/container/input/custom/try_input/0/if_item
