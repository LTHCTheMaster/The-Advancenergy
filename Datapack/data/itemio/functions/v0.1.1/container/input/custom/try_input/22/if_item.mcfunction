...
execute if score #new_count_container itemio.math.input <= #full_stack itemio.math.input run function itemio:v0.1.1/container/input/custom/try_input/22/if_item/inf/test_nbt
execute if score #new_count_container itemio.math.input > #full_stack itemio.math.input if score #count_container itemio.math.input < #full_stack itemio.math.input run function itemio:v0.1.1/container/input/custom/try_input/22/if_item/sup/test_nbt
