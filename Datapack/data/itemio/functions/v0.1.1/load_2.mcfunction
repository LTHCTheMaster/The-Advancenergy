...
execute if score #loaded itemio.math matches 1 run execute as @a[tag=convention.debug] run function itemio:v0.1.1/print_version
...
execute if score #loaded itemio.math matches 0 run schedule function itemio:v0.1.1/load_2 2
