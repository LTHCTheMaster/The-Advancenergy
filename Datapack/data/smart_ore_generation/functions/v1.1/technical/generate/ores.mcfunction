...
#Generate Simplunium Ore (x4)
	...
	summon marker ~ 0 ~ {Tags:["smart_ore_generation.ore_pos"]}
	summon marker ~ 0 ~ {Tags:["smart_ore_generation.ore_pos"]}
	execute as @e[tag=smart_ore_generation.ore_pos,predicate=simplenergy:in_overworld] at @s run function smart_ore_generation:v1.1/technical/generate/simplunium
