...
#Timer & Other
	...
	scoreboard players add #tick_10 lthc.advancenergy.data 1
	...
	execute if score #tick_10 lthc.advancenergy.data matches 10.. run function lthc.advancenergy:core/loops/tick_10
