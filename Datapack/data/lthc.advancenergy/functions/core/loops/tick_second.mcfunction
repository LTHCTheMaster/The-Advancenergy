#Others
	...
	execute as @e[tag=lthc.advancenergy.is_second_ticked,sort=random,predicate=lthc.advancenergy:check_chunk_loaded] at @s run function lthc.advancenergy:utils/scan_machine
