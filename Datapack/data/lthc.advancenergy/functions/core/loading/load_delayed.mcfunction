...
execute in minecraft:overworld run setblock -30000000 -55 1610 minecraft:yellow_shulker_box
...
## Mechanization
execute if score #already2 lthc.advancenergy.data matches 0 if score #mech.ver.major load.status matches 4 if score #mech.ver.minor load.status matches 0 if score #mech.ver.fix load.status matches 0.. run function lthc.advancenergy:core/loading/internal/create_refinery_registry/mechanization_compatibility
## Crazy Adventure
execute if score #already2 lthc.advancenergy.data matches 0 if score CrazyAdventure load.status matches 1000.. run function lthc.advancenergy:core/loading/internal/create_refinery_registry/crazy_adventure_compatibility
## EnergyUtils
execute if score #already2 lthc.advancenergy.data matches 0 if score energyutils.major load.status matches 1 if score energyutils.minor load.status matches 0 if score energyutils.patch load.status matches 0.. run function lthc.advancenergy:core/loading/internal/create_refinery_registry/energyutils_compatibility
