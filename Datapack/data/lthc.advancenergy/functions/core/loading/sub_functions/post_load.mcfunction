...
execute if score #game_version load.status matches 3105.. run tellraw @a[tag=convention.debug] {"text":"[Loaded The Advancenergy v1.0.0]","italic":false,"color":"green"}
