...
# Raw Lead Block
execute store result score @s smithed.data if entity @s[scores={smithed.data=0}] if score count smithed.data matches 1 if data storage smithed.crafter:main root.temp{shapeless_crafting_input:[{Count:9b,tag:{ctc:{id:"raw_lead"}}}]} run loot replace block ~ ~ ~ container.16 loot lthc.advancenergy:i/ores/lead/raw_lead_block
# Lead Block
execute store result score @s smithed.data if entity @s[scores={smithed.data=0}] if score count smithed.data matches 1 if data storage smithed.crafter:main root.temp{shapeless_crafting_input:[{Count:9b,tag:{ctc:{id:"lead_ingot"}}}]} run loot replace block ~ ~ ~ container.16 loot lthc.advancenergy:i/ores/lead/lead_block
# Raw Lead
execute store result score @s smithed.data if entity @s[scores={smithed.data=0}] if score count smithed.data matches 1 if data storage smithed.crafter:main root.temp{shapeless_crafting_input:[{Count:1b,tag:{ctc:{id:"raw_lead_block"}}}]} run loot replace block ~ ~ ~ container.16 loot lthc.advancenergy:i/ores/lead/raw_lead_x9
# Lead Ingot
execute store result score @s smithed.data if entity @s[scores={smithed.data=0}] if score count smithed.data matches 1 if data storage smithed.crafter:main root.temp{shapeless_crafting_input:[{Count:1b,tag:{ctc:{id:"lead_block"}}}]} run loot replace block ~ ~ ~ container.16 loot lthc.advancenergy:i/ores/lead/lead_ingot_x9
