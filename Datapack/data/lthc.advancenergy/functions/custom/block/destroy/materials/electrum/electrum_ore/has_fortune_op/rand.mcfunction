...
scoreboard players operation #enchtemp_rand_0 lthc.advancenergy.data /= #9 lthc.advancenergy.data
...
execute if predicate lthc.advancenergy:luck/2 run scoreboard players add #enchtemp_fortune_copy lthc.advancenergy.data 1
