...
#Place the custom block
	execute as @e[type=area_effect_cloud,tag=lthc.advancenergy.placed,limit=1] at @s run function lthc.advancenergy:custom/block/place/advanced_cable/primary
#Revoke advancement
