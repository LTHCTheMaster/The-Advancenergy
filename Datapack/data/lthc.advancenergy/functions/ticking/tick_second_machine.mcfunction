...
execute if entity @s[tag=lthc.advancenergy.unleashed_carbon_generator] if score @s energy.storage < @s energy.max_storage run function lthc.advancenergy:controller/has_visual/unleashed_carbon_generator
...
execute if entity @s[tag=lthc.advancenergy.mineral_extracting_machine] run function lthc.advancenergy:controller/work/mineral_extracting_machine/
...
execute if entity @s[tag=lthc.advancenergy.solar_generator] if score @s energy.storage < @s energy.max_storage run function lthc.advancenergy:controller/work/solar_generator/
...
execute if entity @s[tag=lthc.advancenergy.alloyer] if score @s energy.storage matches 25.. run function lthc.advancenergy:controller/has_visual/alloyer
