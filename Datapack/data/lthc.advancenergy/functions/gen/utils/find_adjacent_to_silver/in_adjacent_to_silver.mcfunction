...
execute if score #random lthc.advancenergy.data matches 0 if score #temp lthc.advancenergy.data matches 0 run function lthc.advancenergy:gen/utils/find_adjacent_to_silver/variation_down
...
execute if score #random lthc.advancenergy.data matches 1 if score #temp lthc.advancenergy.data matches 0 run function lthc.advancenergy:gen/utils/find_adjacent_to_silver/variation_up
