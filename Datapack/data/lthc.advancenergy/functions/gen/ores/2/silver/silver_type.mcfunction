...
execute store success score #success lthc.advancenergy.data if predicate lthc.advancenergy:check_layer run function lthc.advancenergy:custom/block/place/ores/silver/deepslate_silver_ore/main
