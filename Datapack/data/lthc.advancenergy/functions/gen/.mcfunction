...
# Generate Random Builded Pattern
	execute as @e[limit=3] if predicate lthc.advancenergy:luck/95 run summon area_effect_cloud ~ 0 ~ {Tags:["lthc.advancenergy.ore_pos"],Duration:0}
...
# Generate Random Builded Pattern (2) [Lower Layers]
	execute as @e[limit=1] if predicate lthc.advancenergy:luck/95 run summon area_effect_cloud ~ 0 ~ {Tags:["lthc.advancenergy.ore_pos"],Duration:0}
