...
#define score_holder #min_height
...
scoreboard players set #14 lthc.advancenergy.data 14
scoreboard players set #12 lthc.advancenergy.data 12
...
scoreboard players set #7 lthc.advancenergy.data 7
scoreboard players set #6 lthc.advancenergy.data 6
scoreboard players set #5 lthc.advancenergy.data 5
scoreboard players set #4 lthc.advancenergy.data 4
scoreboard players set #3 lthc.advancenergy.data 3
