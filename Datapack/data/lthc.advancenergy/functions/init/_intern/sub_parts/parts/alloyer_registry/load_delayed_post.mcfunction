...
## Vanilla Items
# Glowstone
data modify storage lthc.advancenergy:main ALLOYER.REGISTRY.vanilla.glowstone.out set value {Slot:16b,id:"minecraft:glowstone_dust",Count:1b}
data modify storage lthc.advancenergy:main ALLOYER.REGISTRY.vanilla.budding_amethyst.out set value {Slot:16b,id:"minecraft:budding_amethyst",Count:1b}
## The Advancenergy
# Bronze
