...
execute if score _defs.checked_version lthc.advancenergy._defs matches 0 run tellraw @a[tag=convention.debug] ["",{"text": "The Advancenergy Error: ERROR] MC 1.19.4 is Required","color": "red","bold": true}]
