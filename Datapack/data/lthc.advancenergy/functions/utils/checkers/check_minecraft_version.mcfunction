...
execute if score _defs.players_present lthc.advancenergy._defs matches 1 if score _defs.minecraft_version lthc.advancenergy._defs matches 3337.. run scoreboard players set _defs.checked_version lthc.advancenergy._defs 1
