...
execute if score _defs.players_present lthc.advancenergy._defs matches 1 store result score _defs.minecraft_version lthc.advancenergy._defs run data get entity @r DataVersion
