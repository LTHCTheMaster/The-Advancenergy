...
execute if score #temp lthc.advancenergy.data matches 1 unless data storage lthc.advancenergy:main GUI[{Slot:11b}] run function lthc.advancenergy:controller/gui_shift_click/alloyer/slot0b/3_move_input_1
execute if score #temp lthc.advancenergy.data matches 0 unless data storage lthc.advancenergy:main GUI[{Slot:13b}] run function lthc.advancenergy:controller/gui_shift_click/alloyer/slot0b/3_move_input_2
