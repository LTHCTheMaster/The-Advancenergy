function lthc.advancenergy:controller/work/advanced_carbon_generator/main
...
execute unless score @s lthc.advancenergy.working matches 0 unless entity @s[tag=lthc.advancenergy.just_end_process] run data modify entity @s Item.tag.CustomModelData set value 170216
