...
# Double output check
execute if score #already lthc.advancenergy.data matches 0 if score #count_of lthc.advancenergy.data matches 1..63 run function lthc.advancenergy:controller/work/refinery/pre_scanner/data_is_1_to_63
