...
execute if score #already2 lthc.advancenergy.data matches 0 if score SimplEnergy load.status matches 1090.. run function lthc.advancenergy:controller/work/refinery/scanner/simplenergy_compatibility/nothing_in_second_output_only
# Crazy Adventure Compatibility
execute if score #already2 lthc.advancenergy.data matches 0 if score CrazyAdventure load.status matches 1000.. run function lthc.advancenergy:controller/work/refinery/scanner/crazy_adventure_compatibility/nothing_in_second_output_only
