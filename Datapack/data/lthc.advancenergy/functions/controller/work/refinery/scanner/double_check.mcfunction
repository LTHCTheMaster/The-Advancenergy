...
### Scanning
# Tin
execute if score #already2 lthc.advancenergy.data matches 0 store success score #already2 lthc.advancenergy.data if data storage lthc.advancenergy:main Items[{Slot:14b,tag:{lthc_advancenergy:{tin_ingot:1b}}}] if data storage lthc.advancenergy:main Items[{Slot:16b,tag:{lthc_advancenergy:{tin_ingot:1b}}}] if data storage lthc.advancenergy:main Items[{Slot:10b,tag:{lthc_advancenergy:{tin_source:1b}}}] run function lthc.advancenergy:controller/work/refinery/scanner/accept_input/owned/tin
# Lead
execute if score #already2 lthc.advancenergy.data matches 0 store success score #already2 lthc.advancenergy.data if data storage lthc.advancenergy:main Items[{Slot:14b,tag:{lthc_advancenergy:{lead_ingot:1b}}}] if data storage lthc.advancenergy:main Items[{Slot:16b,tag:{lthc_advancenergy:{lead_ingot:1b}}}] if data storage lthc.advancenergy:main Items[{Slot:10b,tag:{lthc_advancenergy:{lead_source:1b}}}] run function lthc.advancenergy:controller/work/refinery/scanner/accept_input/owned/lead
# Silver
execute if score #already2 lthc.advancenergy.data matches 0 store success score #already2 lthc.advancenergy.data if data storage lthc.advancenergy:main Items[{Slot:14b,tag:{lthc_advancenergy:{silver_ingot:1b}}}] if data storage lthc.advancenergy:main Items[{Slot:16b,tag:{lthc_advancenergy:{silver_ingot:1b}}}] if data storage lthc.advancenergy:main Items[{Slot:10b,tag:{lthc_advancenergy:{silver_source:1b}}}] run function lthc.advancenergy:controller/work/refinery/scanner/accept_input/owned/silver
# Electrum
execute if score #already2 lthc.advancenergy.data matches 0 store success score #already2 lthc.advancenergy.data if data storage lthc.advancenergy:main Items[{Slot:14b,tag:{lthc_advancenergy:{electrum_ingot:1b}}}] if data storage lthc.advancenergy:main Items[{Slot:16b,tag:{lthc_advancenergy:{electrum_ingot:1b}}}] if data storage lthc.advancenergy:main Items[{Slot:10b,tag:{lthc_advancenergy:{electrum_source:1b}}}] run function lthc.advancenergy:controller/work/refinery/scanner/accept_input/owned/electrum
# Coal
...
# Iron
execute if score #already2 lthc.advancenergy.data matches 0 store success score #already2 lthc.advancenergy.data if data storage lthc.advancenergy:main Items[{Slot:14b,id:"minecraft:iron_ingot"}] if data storage lthc.advancenergy:main Items[{Slot:16b,id:"minecraft:iron_ingot"}] run function lthc.advancenergy:controller/work/refinery/scanner/input_checking/iron
# Gold
execute if score #already2 lthc.advancenergy.data matches 0 store success score #already2 lthc.advancenergy.data if data storage lthc.advancenergy:main Items[{Slot:14b,id:"minecraft:gold_ingot"}] if data storage lthc.advancenergy:main Items[{Slot:16b,id:"minecraft:gold_ingot"}] run function lthc.advancenergy:controller/work/refinery/scanner/input_checking/gold
# Netherite
...
execute if score #already2 lthc.advancenergy.data matches 0 if score SimplEnergy load.status matches 1090.. run function lthc.advancenergy:controller/work/refinery/scanner/simplenergy_compatibility/double_check
# Crazy Adventure Compatibility
execute if score #already2 lthc.advancenergy.data matches 0 if score CrazyAdventure load.status matches 1000.. run function lthc.advancenergy:controller/work/refinery/scanner/crazy_adventure_compatibility/double_check
