...
#Cooling
execute if data storage lthc.advancenergy:main Items[{Slot:11b,id:"minecraft:water_bucket"}] unless score @s lthc.advancenergy.water matches 91.. run function lthc.advancenergy:controller/work/advanced_carbon_generator/cooling
...
execute unless score @s lthc.advancenergy.working matches 0 run function lthc.advancenergy:controller/work/advanced_carbon_generator/unless_stopped
