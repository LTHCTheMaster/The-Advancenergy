...
execute if score #is_there_water lthc.advancenergy.data matches 0 store success score #is_there_water lthc.advancenergy.data positioned ~-1 ~ ~ if block ~ ~ ~ water
execute if score #is_there_water lthc.advancenergy.data matches 0 store success score #is_there_water lthc.advancenergy.data positioned ~1 ~ ~ if block ~ ~ ~ water
execute if score #is_there_water lthc.advancenergy.data matches 0 store success score #is_there_water lthc.advancenergy.data positioned ~ ~ ~-1 if block ~ ~ ~ water
execute if score #is_there_water lthc.advancenergy.data matches 0 store success score #is_there_water lthc.advancenergy.data positioned ~ ~ ~1 if block ~ ~ ~ water
execute if score #is_there_water lthc.advancenergy.data matches 0 store success score #is_there_water lthc.advancenergy.data positioned ~ ~-1 ~ if block ~ ~ ~ water
