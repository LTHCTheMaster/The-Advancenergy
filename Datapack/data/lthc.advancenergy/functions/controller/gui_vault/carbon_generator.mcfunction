...
execute if score #first_slot lthc.advancenergy.data matches ..24 run function lthc.advancenergy:controller/gui_vault/carbon_generator/clean_vault
...
execute if score #cleaned lthc.advancenergy.data matches 1 run function lthc.advancenergy:controller/gui_vault/carbon_generator/restore_vault_cleaned
