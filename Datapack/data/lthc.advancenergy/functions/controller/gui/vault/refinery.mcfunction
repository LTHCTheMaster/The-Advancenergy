...
execute if score #first_slot lthc.advancenergy.data matches ..25 run function lthc.advancenergy:controller/gui/vault/refinery/clean_vault
...
execute if score #cleaned lthc.advancenergy.data matches 1 run function lthc.advancenergy:controller/gui/vault/refinery/restore_vault_cleaned
