#Others
	...
	execute as @e[type=#energy:valid_block_entities,tag=lthc.advancenergy.is_machine] at @s run function lthc.advancenergy:ticking/tick_second_machine
...
# Special
	execute as @e[type=glow_item_frame,tag=lthc.advancenergy.is_bomb] at @s run function lthc.advancenergy:ticking/tick_second_bomb
