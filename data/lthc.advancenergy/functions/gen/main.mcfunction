...
# Generate Lead Ore with "natural ("IRL")" adjacency
	...
	execute as @e[type=area_effect_cloud,tag=lthc.advancenergy.ore_pos] at @s run function lthc.advancenergy:gen/ores/lead/lead_natural
# Generate Lead Ore with air adjacency
	...
	execute as @e[type=area_effect_cloud,tag=lthc.advancenergy.ore_pos] at @s run function lthc.advancenergy:gen/ores/lead/lead_air
