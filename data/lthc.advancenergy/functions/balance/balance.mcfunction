...
#Collect power
	...
	execute align xyz positioned ~ ~1 ~ as @e[type=#energy:valid_block_entities,tag=!lthc.advancenergy.balance,tag=!lthc.advancenergy.balanced,tag=lthc.advancenergy.balancing,dx=0,dy=0,dz=0] if score @s energy.max_storage = #temp lthc.advancenergy.data at @s run function lthc.advancenergy:balance/found
	execute align xyz positioned ~ ~-1 ~ as @e[type=#energy:valid_block_entities,tag=!lthc.advancenergy.balance,tag=!lthc.advancenergy.balanced,tag=lthc.advancenergy.balancing,dx=0,dy=0,dz=0] if score @s energy.max_storage = #temp lthc.advancenergy.data at @s run function lthc.advancenergy:balance/found
	execute align xyz positioned ~ ~ ~1 as @e[type=#energy:valid_block_entities,tag=!lthc.advancenergy.balance,tag=!lthc.advancenergy.balanced,tag=lthc.advancenergy.balancing,dx=0,dy=0,dz=0] if score @s energy.max_storage = #temp lthc.advancenergy.data at @s run function lthc.advancenergy:balance/found
	execute align xyz positioned ~ ~ ~-1 as @e[type=#energy:valid_block_entities,tag=!lthc.advancenergy.balance,tag=!lthc.advancenergy.balanced,tag=lthc.advancenergy.balancing,dx=0,dy=0,dz=0] if score @s energy.max_storage = #temp lthc.advancenergy.data at @s run function lthc.advancenergy:balance/found
	execute align xyz positioned ~1 ~ ~ as @e[type=#energy:valid_block_entities,tag=!lthc.advancenergy.balance,tag=!lthc.advancenergy.balanced,tag=lthc.advancenergy.balancing,dx=0,dy=0,dz=0] if score @s energy.max_storage = #temp lthc.advancenergy.data at @s run function lthc.advancenergy:balance/found
...
#Redistributes Energy
	...
	scoreboard players operation @e[type=#energy:valid_block_entities,tag=lthc.advancenergy.balance] energy.storage = #balance lthc.advancenergy.data
