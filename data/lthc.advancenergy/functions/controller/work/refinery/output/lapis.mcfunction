...
execute if score #success lthc.advancenergy.data matches 0 run data modify storage lthc.advancenergy:main Items[{Slot:14b}] set value {Slot:14b,id:"minecraft:lapis_lazuli",Count:3b}
# 16b slot
scoreboard players set #success lthc.advancenergy.data 0
...
execute if score #success lthc.advancenergy.data matches 0 run data modify storage lthc.advancenergy:main Items[{Slot:16b}] set value {Slot:16b,id:"minecraft:lapis_lazuli",Count:3b}
