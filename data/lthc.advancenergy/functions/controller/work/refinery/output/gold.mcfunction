...
tellraw @a [{"score":{"objective": "lthc.advancenergy.data","name": "#success"}}]
...
execute if score #success lthc.advancenergy.data matches 0 run data modify storage lthc.advancenergy:main Items append value {Slot:16b,id:"minecraft:gold_nugget",Count:2b}
