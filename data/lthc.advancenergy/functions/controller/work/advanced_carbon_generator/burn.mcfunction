...
#Execute
execute if score @s lthc.advancenergy.water matches 0 run function lthc.advancenergy:controller/work/advanced_carbon_generator/destroy

scoreboard players remove @s lthc.advancenergy.water 10
