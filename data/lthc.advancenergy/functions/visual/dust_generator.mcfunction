execute if score @s energy.storage < @s energy.max_storage run function lthc.advancenergy:work/dust_generator/main
execute if predicate lthc.advancenergy:is_barrel_open run function lthc.advancenergy:visual/dust_generator_2
